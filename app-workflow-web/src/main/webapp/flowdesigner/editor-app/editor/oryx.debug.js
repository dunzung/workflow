 ...
 * @type {string}
 */
ORYX.CONFIG.MODELER_RES_PATH_ROOT =     ACTIVITI.CONFIG.contextRoot + "/flowdesigner";
ORYX.CONFIG.ROOT_PATH =					ORYX.CONFIG.MODELER_RES_PATH_ROOT + "/editor-app/editor";
ORYX.CONFIG.EXPLORER_PATH =				ORYX.CONFIG.MODELER_RES_PATH_ROOT + "/editor-app/explorer";
ORYX.CONFIG.LIBS_PATH =					ORYX.CONFIG.MODELER_RES_PATH_ROOT + "/editor-app/libs";
...
ORYX.CONFIG.PLUGINS_CONFIG =				ORYX.CONFIG.MODELER_RES_PATH_ROOT + "/editor-app/plugins.xml";
...
ORYX.Core.StencilSet.StencilSet = Clazz.extend({
    ...
    construct: function(source, modelMetaData, editorId){
		...
		if(ORYX.CONFIG.BACKEND_SWITCH) {
			...
			//new Ajax.Request(ACTIVITI.CUSTOM_URL.custom_stencilset_url+'?version=' + Date.now(), {
			new Ajax.Request(ACTIVITI.CUSTOM_URL.custom_stencilset_url, {
	            asynchronous: false,
	            method: 'get',
